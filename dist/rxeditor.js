...
function Mt(e, t, n, r, i) {
	...
	e.doc.nodesBetween(t, n, (t, n) => {
		...
		if (t.isTextblock && !t.hasMarkup(r, s) && Ft(e.doc, e.mapping.slice(o).map(n), r)) {
			let i = null;
			if (r.schema.linebreakReplacement) {
				let e = r.whitespace == "pre", t = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
				e && !t ? i = !1 : !e && t && (i = !0);
			}
			i === !1 && Pt(e, t, n, o), Dt(e, e.mapping.slice(o).map(n, 1), r, void 0, i === null);
			let c = e.mapping.slice(o), l = c.map(n, 1), u = c.map(n + t.nodeSize, 1);
			return e.step(new C(l, u, l + 1, u - 1, new d(a.from(r.create(s, null, t.marks)), 0, 0), 1, !0)), i === !0 && Nt(e, t, n, o), !1;
		}
	});
}
function Nt(e, t, n, r) {
...
function Ht(e, t, n) {
	...
	if (e.step(new S(l, c.map(t + n, -1), d.empty, !0)), r === !0) {
		...
		Nt(e, t.node(), t.before(), e.steps.length);
	}
	return e;
}
function Ut(e, t, n) {
...
function Gt(e, t, n = t, r = d.empty) {
	if (t == n && !r.size) return null;
	let i = e.resolve(t), a = e.resolve(n);
	return Kt(i, a, r) ? new S(t, n, r) : new qt(i, a, r).fit();
}
function Kt(e, t, n) {
...
var qt = class {
	...
	findFittable() {
		...
		for (let t = 1; t <= 2; t++) for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
			let e, r = null;
			n ? (r = Xt(this.unplaced.content, n - 1).firstChild, e = r.content) : e = this.unplaced.content;
			let i = e.firstChild;
	...
	openMore() {
		let { content: e, openStart: t, openEnd: n } = this.unplaced, r = Xt(e, t);
	...
	dropNode() {
		...
		if (r.childCount <= 1 && t > 0) {
			...
			this.unplaced = new d(Jt(e, t - 1, 1), t - 1, i ? t - 1 : n);
		} else this.unplaced = new d(Jt(e, t, 1), t, n);
	}
	placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: i }) {
		...
		for (; l < s.childCount;) {
			...
			if (!t) break;
			l++, (l > 1 || c == 0 || e.content.size) && (f = t, u.push(Zt(e.mark(p.allowedMarks(e.marks)), l == 1 ? c : 0, l == s.childCount ? m : -1)));
		}
		let h = l == s.childCount;
		h || (m = -1), this.placed = Yt(this.placed, t, a.from(u)), this.frontier[t].match = f, h && m < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
		...
		this.unplaced = h ? e == 0 ? d.empty : new d(Jt(o.content, e - 1, 1), e - 1, m < 0 ? o.openEnd : e - 1) : new d(Jt(o.content, e, l), o.openStart, o.openEnd);
	}
	mustMoveInline() {
	...
	findCloseLevel(e) {
		scan: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
			let { match: n, type: r } = this.frontier[t], i = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), a = Qt(e, t, r, n, i);
			if (a) {
				for (let n = t - 1; n >= 0; n--) {
					let { match: t, type: r } = this.frontier[n], i = Qt(e, n, r, t, !0);
	...
	close(e) {
		...
		t.fit.childCount && (this.placed = Yt(this.placed, t.depth, t.fit)), e = t.move;
	...
	openFrontierNode(e, t = null, n) {
		...
		r.match = r.match.matchType(e), this.placed = Yt(this.placed, this.depth, a.from(e.create(t, n))), this.frontier.push({
			type: e,
	...
	closeFrontierNode() {
		...
		e.childCount && (this.placed = Yt(this.placed, this.frontier.length, e));
	}
};
function Jt(e, t, n) {
	return t == 0 ? e.cutByIndex(n, e.childCount) : e.replaceChild(0, e.firstChild.copy(Jt(e.firstChild.content, t - 1, n)));
}
function Yt(e, t, n) {
	return t == 0 ? e.append(n) : e.replaceChild(e.childCount - 1, e.lastChild.copy(Yt(e.lastChild.content, t - 1, n)));
}
function Xt(e, t) {
...
function Zt(e, t, n) {
	if (t <= 0) return e;
	let r = e.content;
	return t > 1 && (r = r.replaceChild(0, Zt(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))), t > 0 && (r = e.type.contentMatch.fillBefore(r).append(r), n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(a.empty, !0)))), e.copy(r);
}
function Qt(e, t, n, r, i) {
	...
	return s && !$t(n, a.content, o) ? s : null;
}
function $t(e, t, n) {
...
function tn(e, t, n, r) {
	...
	if (Kt(i, a, r)) return e.step(new S(t, n, r));
	let o = on(i, a);
	...
	for (let t = r.openStart; t >= 0; t--) {
		...
		if (f) for (let t = 0; t < o.length; t++) {
			...
			if (p.canReplaceWith(m, m, f.type, f.marks)) return e.replace(i.before(l), u ? a.after(l) : n, new d(nn(r.content, 0, r.openStart, s), s, r.openEnd));
		}
	}
...
function nn(e, t, n, r, i) {
	if (t < n) {
		let i = e.firstChild;
		e = e.replaceChild(0, i.copy(nn(i.content, t + 1, n, r, i)));
	}
	if (t > r) {
...
}, ln.prototype = Object.create(Error.prototype), ln.prototype.constructor = ln, ln.prototype.name = "TransformError";
var un = class {
	constructor(e) {
	...
	step(e) {
		...
		if (t.failed) throw new ln(t.failed);
		return this;
	}
	maybeStep(e) {
	...
	setNodeAttribute(e, t, n) {
		return this.step(new sn(e, t, n)), this;
	}
	setDocAttribute(e, t) {
	...
	replace(e, t = d.empty) {
		...
		for (let o = 0; o < a.length; o++) {
			...
			e.replaceRange(l.map(s.pos), l.map(c.pos), o ? d.empty : t), o == 0 && bn(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
		}
	}
	replaceWith(e, t) {
	...
	static findFrom(e, t, n = !1) {
		let r = e.parent.inlineContent ? new T(e) : yn(e.node(0), e.parent, e.pos, e.index(), t, n);
		if (r) return r;
		for (let r = e.depth - 1; r >= 0; r--) {
			let i = t < 0 ? yn(e.node(0), e.node(r), e.before(r + 1), e.index(r), t, n) : yn(e.node(0), e.node(r), e.after(r + 1), e.index(r) + 1, t, n);
			if (i) return i;
		}
		return null;
	}
	static near(e, t = 1) {
		return this.findFrom(e, t) || this.findFrom(e, -t) || new _n(e.node(0));
	}
	static atStart(e) {
		return yn(e, e, 0, 0, 1) || new _n(e);
	}
	static atEnd(e) {
		return yn(e, e, e.content.size, e.childCount, -1) || new _n(e);
	}
	static fromJSON(e, t) {
...
function mn(e) {
	!pn && !e.parent.inlineContent && (pn = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + e.parent.type.name + ")"));
}
...
function yn(e, t, n, r, i, a = !1) {
	...
	for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < t.childCount : o >= 0; o += i) {
		let r = t.child(o);
		if (!r.isAtom) {
			let t = yn(e, r, n + i, i < 0 ? r.childCount : 0, i, a);
			if (t) return t;
...
var xn = 1, Sn = 2, Cn = 4, wn = class extends un {
	constructor(e) {
	...
	setSelection(e) {
		...
		return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | xn) & -3, this.storedMarks = null, this;
	}
	get selectionSet() {
		return (this.updated & xn) > 0;
	}
	setStoredMarks(e) {
		return this.storedMarks = e, this.updated |= Sn, this;
	}
	ensureMarks(e) {
...
var En = class {
	...
	constructor(e, t) {
		this.schema = e, this.plugins = [], this.pluginsByKey = Object.create(null), this.fields = Dn.slice(), t && t.forEach((e) => {
			if (this.pluginsByKey[e.key]) throw RangeError("Adding different instances of a keyed plugin (" + e.key + ")");
			this.plugins.push(e), this.pluginsByKey[e.key] = e, e.spec.state && this.fields.push(new En(e.key, e.spec.state, e));
		});
	}
}, kn = class e {
	constructor(e) {
	...
	static create(t) {
		let n = new On(t.doc ? t.doc.type.schema : t.schema, t.plugins), r = new e(n);
		for (let e = 0; e < n.fields.length; e++) r[n.fields[e].name] = n.fields[e].init(t, r);
		return r;
	}
	reconfigure(t) {
		let n = new On(this.schema, t.plugins), r = n.fields, i = new e(n);
		for (let e = 0; e < r.length; e++) {
			let n = r[e].name;
	...
	static fromJSON(t, n, r) {
		...
		let i = new On(t.schema, t.plugins), a = new e(i);
...
function An(e, t, n) {
	for (let r in e) {
		let i = e[r];
		i instanceof Function ? i = i.bind(t) : r == "handleDOMEvents" && (i = An(i, t, {})), n[r] = i;
	}
	return n;
}
var jn = class {
	constructor(e) {
		this.spec = e, this.props = {}, e.props && An(e.props, this, this.props), this.key = e.key ? e.key.key : Nn("plugin");
	}
	getState(e) {
		return e[this.key];
	}
...
var Ln = (e, t, n) => {
	...
	if (r.parent.content.size == 0 && (Rn(a, "end") || E.isSelectable(a))) for (let n = r.depth;; n--) {
		let o = Gt(e.doc, r.before(n), r.after(n), d.empty);
		if (o && o.slice.size < o.to - o.from) {
			if (t) {
				let n = e.tr.step(o);
				n.setSelection(Rn(a, "end") ? w.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1) : E.create(n.doc, i.pos - a.nodeSize)), t(n.scrollIntoView());
			}
			return !0;
		}
...
var Hn = (e, t, n) => {
	...
	let a = i.nodeAfter;
	if (er(e, i, t, 1)) return !0;
	if (r.parent.content.size == 0 && (Rn(a, "start") || E.isSelectable(a))) {
		let n = Gt(e.doc, r.before(), r.after(), d.empty);
		if (n && n.slice.size < n.to - n.from) {
			if (t) {
				let r = e.tr.step(n);
				r.setSelection(Rn(a, "start") ? w.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1) : E.create(r.doc, r.mapping.map(i.pos))), t(r.scrollIntoView());
			}
			return !0;
		}
	}
...
var qn = (e, t) => {
	...
	if (n instanceof _n || r.parent.inlineContent || i.parent.inlineContent) return !1;
...
function Xn(e) {
	return (t, n) => {
		if (t.selection instanceof E && t.selection.node.isBlock) {
			...
			return !e.parentOffset || !Lt(t.doc, e.pos) ? !1 : (n && n(t.tr.split(e.pos).scrollIntoView()), !0);
		}
		if (!t.selection.$from.depth) return !1;
		let r = t.tr;
		!t.selection.empty && (t.selection instanceof T || t.selection instanceof _n) && r.deleteSelection();
		let { $from: i } = r.selection, a = r.steps.length, o = [], s, c, l = !1, u = !1;
		for (let t = i.depth;; t--) if (i.node(t).isBlock) {
			l = i.end(t) == i.pos + (i.depth - t), u = i.start(t) == i.pos - (i.depth - t), c = Kn(i.node(t - 1).contentMatchAt(i.indexAfter(t - 1)));
		...
		let d = i.pos, f = Lt(r.doc, d, o.length, o);
		if (f || (o[0] = c ? { type: c } : null, f = Lt(r.doc, d, o.length, o)), !f) return !1;
...
var Zn = Xn(), Qn = (e, t) => (t && t(e.tr.setSelection(new _n(e.doc))), !0);
function $n(e, t, n) {
	let r = t.nodeBefore, i = t.nodeAfter, a = t.index();
	return !r || !i || !r.type.compatibleContent(i.type) ? !1 : !r.content.size && t.parent.canReplace(a - 1, a) ? (n && n(e.tr.delete(t.pos - r.nodeSize, t.pos).scrollIntoView()), !0) : !t.parent.canReplace(a, a + 1) || !(i.isTextblock || zt(e.doc, t.pos)) ? !1 : (n && n(e.tr.join(t.pos).scrollIntoView()), !0);
}
function er(e, t, n, r) {
	...
	if (u && (s = (c = i.contentMatchAt(i.childCount)).findWrapping(o.type)) && c.matchType(s[0] || o.type).validEnd) {
		if (n) {
			...
			u.nodeAfter && u.nodeAfter.type == i.type && zt(l.doc, u.pos) && l.join(u.pos), n(l.scrollIntoView());
		}
		return !0;
	}
...
var ar = ir(Fn, Ln, zn), or = ir(Fn, Hn, Un), D = {
	Enter: ir(Gn, Jn, Yn, Zn),
	"Mod-Enter": qn,
	Backspace: ar,
	"Mod-Backspace": ar,
	"Shift-Backspace": ar,
...
for (let e in D) sr[e] = D[e];
var cr = (typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : typeof os < "u" && os.platform && os.platform() == "darwin") ? sr : D;
//#endregion
//#region node_modules/prosemirror-dropcursor/dist/index.js
function lr(e = {}) {
	return new jn({ view(t) {
		return new ur(t, e);
	} });
}
for (var ur = class {
	...
	computeTarget(e) {
		...
		if (this.editorView.dragging && this.editorView.dragging.slice) {
			let e = Wt(this.editorView.state.doc, a, this.editorView.dragging.slice);
			e != null && (a = e);
		}
		return a;
	}
	...
	221: "}",
	222: "\""
}, pr = typeof navigator < "u" && /Mac/.test(navigator.platform), mr = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), O = 0; O < 10; O++) dr[48 + O] = dr[96 + O] = String(O);
for (var O = 1; O <= 24; O++) dr[O + 111] = "F" + O;
for (var O = 65; O <= 90; O++) dr[O] = String.fromCharCode(O + 32), fr[O] = String.fromCharCode(O);
for (var hr in dr) fr.hasOwnProperty(hr) || (fr[hr] = dr[hr]);
function gr(e) {
	var t = !(pr && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || mr && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? fr : dr)[e.keyCode] || e.key || "Unidentified";
	return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
//#endregion
//#region node_modules/prosemirror-keymap/dist/index.js
var _r = typeof navigator < "u" && /Mac|iP(hone|[oa]d)/.test(navigator.platform), vr = typeof navigator < "u" && /Win/.test(navigator.platform);
function yr(e) {
	...
	for (let e = 0; e < t.length - 1; e++) {
		...
		else if (/^mod$/i.test(n)) _r ? o = !0 : i = !0;
...
function Sr(e) {
	return new jn({ props: { handleKeyDown: Cr(e) } });
}
function Cr(e) {
	let t = br(e);
	return function(e, n) {
		let r = gr(n), i, a = t[xr(r, n)];
		...
		if (r.length == 1 && r != " ") {
			...
			if ((n.altKey || n.metaKey || n.ctrlKey) && !(vr && n.ctrlKey && n.altKey) && (i = dr[n.keyCode]) && i != r) {
				let r = t[xr(i, n)];
...
var k = function(e) {
	...
	let r = Tr || (Tr = document.createRange());
...
function jr(e, t) {
	for (;;) {
		...
		if (e.nodeType == 1 && t > 0) {
			...
			e = e.childNodes[t - 1], t = A(e);
		} else if (e.parentNode && !Pr(e)) t = k(e), e = e.parentNode;
		else return null;
	}
}
function Mr(e, t) {
	for (;;) {
		...
		} else if (e.parentNode && !Pr(e)) t = k(e) + 1, e = e.parentNode;
		else return null;
	}
}
function Nr(e, t, n) {
	for (let r = t == 0, i = t == A(e); r || i;) {
		if (e == n) return !0;
		let t = k(e);
...
function Rr(e, t, n) {
	if (e.caretPositionFromPoint) try {
		...
		if (r) return {
			node: r.offsetNode,
			offset: Math.min(A(r.offsetNode), r.offset)
		};
	} catch {}
	if (e.caretRangeFromPoint) {
		...
		if (r) return {
			...
			offset: Math.min(A(r.startContainer), r.startOffset)
		};
	}
}
var j = typeof navigator < "u" ? navigator : null, zr = typeof document < "u" ? document : null, Br = j && j.userAgent || "", Vr = /Edge\/(\d+)/.exec(Br), Hr = /MSIE \d/.exec(Br), Ur = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Br), M = !!(Hr || Ur || Vr), Wr = Hr ? document.documentMode : Ur ? +Ur[1] : Vr ? +Vr[1] : 0, N = !M && /gecko\/(\d+)/i.test(Br);
N && +(/Firefox\/(\d+)/.exec(Br) || [0, 0])[1];
var Gr = !M && /Chrome\/(\d+)/.exec(Br), P = !!Gr, Kr = Gr ? +Gr[1] : 0, F = !M && !!j && /Apple Computer/.test(j.vendor), qr = F && (/Mobile\/\w+/.test(Br) || !!j && j.maxTouchPoints > 2), I = qr || (j ? /Mac/.test(j.platform) : !1), Jr = j ? /Win/.test(j.platform) : !1, L = /Android \d/.test(Br), Yr = !!zr && "webkitFontSmoothing" in zr.documentElement.style, Xr = Yr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Zr(e) {
...
function $r(e, t, n) {
	...
	for (let o = n || e.dom; o;) {
		...
		let e = o, n = e == a.body, s = n ? Zr(a) : Qr(e), c = 0, l = 0;
		if (t.top < s.top + R(r, "top") ? l = -(s.top - t.top + R(i, "top")) : t.bottom > s.bottom - R(r, "bottom") && (l = t.bottom - t.top > s.bottom - s.top ? t.top + R(i, "top") - s.top : t.bottom - s.bottom + R(i, "bottom")), t.left < s.left + R(r, "left") ? c = -(s.left - t.left + R(i, "left")) : t.right > s.right - R(r, "right") && (c = t.right - s.right + R(i, "right")), c || l) {
...
function pi(e, t) {
	...
	if (F) for (let e = o; r && e; e = wr(e)) e.draggable && (r = void 0);
	if (o = li(o, t), r) {
		if (N && r.nodeType == 1 && (i = Math.min(i, r.childNodes.length), i < r.childNodes.length)) {
			let e = r.childNodes[i], n;
			e.nodeName == "IMG" && (n = e.getBoundingClientRect()).right <= t.left && n.bottom > t.top && i++;
		}
		let n;
		Yr && i && r.nodeType == 1 && (n = r.childNodes[i - 1]).nodeType == 1 && n.contentEditable == "false" && n.getBoundingClientRect().top >= t.top && i--, r == e.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && t.top > r.lastChild.getBoundingClientRect().bottom ? s = e.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (s = di(e, r, i, t));
	}
	s ?? (s = ui(e, o, t));
...
var gi = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function _i(e, t, n) {
	let { node: r, offset: i, atom: a } = e.docView.domFromPos(t, n < 0 ? -1 : 1), o = Yr || N;
	if (r.nodeType == 3) {
		if (o && (gi.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
			let e = hi(Er(r, i, i), n);
			if (N && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
				let t = hi(Er(r, i - 1, i - 1), -1);
				if (t.top == e.top) {
					let n = hi(Er(r, i, i + 1), -1);
		...
		}
		{
			...
			return n < 0 && !i ? (t++, a = -1) : n >= 0 && i == r.nodeValue.length ? (e--, a = 1) : n < 0 ? e-- : t++, vi(hi(Er(r, e, t), a), a < 0);
		}
	}
	if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
		if (a == null && i && (n < 0 || i == A(r))) {
	...
	if (a == null && i && (n < 0 || i == A(r))) {
		let e = r.childNodes[i - 1], t = e.nodeType == 3 ? Er(e, A(e) - +!o) : e.nodeType == 1 && (e.nodeName != "BR" || !e.nextSibling) ? e : null;
	...
	return vi(hi(r.nodeType == 3 ? Er(r) : r, -n), n >= 0);
}
function vi(e, t) {
...
var z = 0, Oi = 1, ki = 2, B = 3, Ai = class {
	constructor(e, t, n, r) {
		this.parent = e, this.children = t, this.dom = n, this.contentDOM = r, this.dirty = z, n.pmViewDesc = this;
	}
	matchesWidget(e) {
		return !1;
	}
	...
	setSelection(e, t, n, r = !1) {
		...
		if (N && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
			let e = l.focusNode.childNodes[l.focusOffset];
			e && e.contentEditable == "false" && (r = !0);
		}
		if (!(r || u && F) && Or(o.node, o.offset, l.anchorNode, l.anchorOffset) && Or(s.node, s.offset, l.focusNode, l.focusOffset)) return;
		let d = !1;
		if ((c.extend || e == t) && !(u && N)) {
	...
	markDirty(e, t) {
		for (let n = 0, r = 0; r < this.children.length; r++) {
			...
			if (n == a ? e <= a && t >= n : e < a && t > n) {
				...
				if (e >= r && t <= o) {
					this.dirty = e == n || t == a ? ki : Oi, e == r && t == o && (i.contentLost || i.dom.parentNode != this.contentDOM) ? i.dirty = B : i.markDirty(e - r, t - r);
					return;
				}
				i.dirty = i.dom == i.contentDOM && i.dom.parentNode == this.contentDOM && !i.children.length ? ki : B;
			}
			n = a;
		}
		this.dirty = ki;
	...
	parseRule() {
		return this.dirty & B || this.mark.type.spec.reparseInView ? null : {
	...
	matchesMark(e) {
		return this.dirty != B && this.mark.eq(e);
	}
	markDirty(e, t) {
		if (super.markDirty(e, t), this.dirty != z) {
			let e = this.parent;
			for (; !e.node;) e = e.parent;
			e.dirty < this.dirty && (e.dirty = this.dirty), this.dirty = z;
		}
	}
	slice(t, n, r) {
	...
	static create(t, n, r, i, a, o) {
		...
		let f = u;
		return u = Gi(u, r, n), l ? c = new Ri(t, n, r, i, u, d || null, f, l) : n.isText ? new Ii(t, n, r, i, u, f) : new e(t, n, r, i, u, d || null, f);
	}
	parseRule(e) {
	...
	matchesNode(e, t, n) {
		return this.dirty == z && e.eq(this.node) && Ki(t, this.outerDeco) && n.eq(this.innerDeco);
	}
	get size() {
	...
	updateChildren(e, t) {
		let n = this.node.inlineContent, r = t, i = e.composing ? this.localCompositionInfo(e, t) : null, a = i && i.pos > -1 ? i : null, o = i && i.pos < 0, s = new Ji(this, a && a.node, e);
		...
		}), s.syncToMarks([], n, e, 0), this.node.isTextblock && s.addTextblockHacks(), s.destroyRest(), (s.changed || this.dirty == ki) && (a && this.protectLocalComposition(e, a), zi(this.contentDOM, this.children, e), qr && Qi(this.dom));
	}
	...
	update(e, t, n, r) {
		return this.dirty == B || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, n, r), !0);
	}
	updateInner(e, t, n, r) {
		this.updateOuterDeco(t), this.node = e, this.innerDeco = n, this.contentDOM && this.updateChildren(r, this.posAtStart), this.dirty = z;
	}
	updateOuterDeco(e) {
...
function Fi(e, t, n, r, i) {
	Gi(r, t, e);
	let a = new Pi(void 0, e, t, n, r, r, r);
...
var Ii = class e extends Pi {
	...
	update(e, t, n, r) {
		return this.dirty == B || this.dirty != z && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != z || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, r.trackWrites == this.nodeDOM && (r.trackWrites = null)), this.node = e, this.dirty = z, !0);
	}
	inParent() {
	...
	markDirty(e, t) {
		super.markDirty(e, t), this.dom != this.nodeDOM && (e == 0 || t == this.nodeDOM.nodeValue.length) && (this.dirty = B);
	}
	get domAtom() {
		return !1;
	}
...
var Ji = class {
	...
	syncToMarks(e, t, n, r) {
		...
		for (; i < a;) this.destroyRest(), this.top.dirty = z, this.index = this.stack.pop(), this.top = this.stack.pop(), a--;
		for (; a < e.length;) {
			...
			if (i < 0 && this.index < this.top.children.length) {
				...
				t instanceof Ni && t.dirty != B && t.mark.type == e[a].type && t.spec.update && !this.isLocked(t.dom) && t.spec.update(e[a]) && (t.mark = e[a], i = this.index, this.changed = !0);
			}
	...
	updateNodeAt(e, t, n, r, i) {
		let a = this.top.children[r];
		return a.dirty == B && a.dom == a.contentDOM && (a.dirty = ki), a.update(e, t, n, i) ? (this.destroyBetween(this.index, r), this.index++, !0) : !1;
	}
	...
	updateNextNode(e, t, n, r, i, a) {
		for (let o = this.index; o < this.top.children.length; o++) {
			...
			if (s instanceof Pi) {
				...
				let l = s.dom, u, d = this.isLocked(l) && !(e.isText && s.node && s.node.isText && s.nodeDOM.nodeValue == e.text && s.dirty != B && Ki(t, s.outerDeco));
				if (!d && s.update(e, t, n, r)) return this.destroyBetween(this.index, o), s.dom != l && (this.changed = !0), this.index++, !0;
				if (!d && (u = this.recreateWrapper(s, e, t, n, r, a))) return this.destroyBetween(this.index, o), this.top.children[this.index] = u, u.contentDOM && (u.dirty = ki, u.updateChildren(r, a + 1), u.dirty = z), this.changed = !0, this.index++, !0;
				break;
			}
		}
		return !1;
...
function ta(e, t = null) {
	...
	if (Fr(n)) {
		...
		let e = i.node;
		if (i && e.isAtom && E.isSelectable(e) && i.parent && !(e.isInline && Nr(n.focusNode, n.focusOffset, i.dom))) {
			let e = i.posBefore;
...
function V(e, t = !1) {
	...
	if (e.domObserver.disconnectSelection(), e.cursorWrapper) ca(e);
		...
		ra && !(n instanceof T) && (n.$from.parent.inlineContent || (a = ia(e, n.from)), !n.empty && !n.$from.parent.inlineContent && (o = ia(e, n.to))), e.docView.setSelection(r, i, e, t), ra && (a && oa(a), o && oa(o)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && sa(e));
	}
...
function ia(e, t) {
	...
	if (F && i && i.contentEditable == "false") return aa(i);
...
function ca(e) {
	...
	r ? t.collapse(n.parentNode, k(n) + 1) : t.collapse(n, 0), !r && !e.state.selection.visible && M && Wr <= 11 && (n.disabled = !0, n.disabled = !1);
}
function la(e, t) {
	if (t instanceof E) {
		let n = e.docView.descAt(t.from);
		n != e.lastSelectedViewDesc && (ua(e), n && n.selectNode(), e.lastSelectedViewDesc = n);
	} else ua(e);
}
function ua(e) {
...
function _a(e, t, n) {
	...
	if (r instanceof T) {
		if (n.indexOf("s") > -1) {
			...
			return ga(e, new T(r.$anchor, a));
		}
		if (!r.empty) return !1;
		if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
			let n = ha(e.state, t);
			return n && n instanceof E ? ga(e, n) : !1;
		}
		if (!(I && n.indexOf("m") > -1)) {
			let n = r.$head, i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter, a;
			if (!i || i.isText) return !1;
			let o = t < 0 ? n.pos - i.nodeSize : n.pos;
			return i.isAtom || (a = e.docView.descAt(o)) && !a.contentDOM ? E.isSelectable(i) ? ga(e, new E(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n)) : Yr ? ga(e, new T(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize))) : !1 : !1;
		}
	} else if (r instanceof E && r.node.isInline) return ga(e, new T(t > 0 ? r.$to : r.$from));
	else {
		let n = ha(e.state, t);
		return n ? ga(e, n) : !1;
	}
...
function ba(e, t) {
	return t < 0 ? xa(e) : Sa(e);
}
function xa(e) {
	let t = e.domSelectionRange(), n = t.focusNode, r = t.focusOffset;
	if (!n) return;
	let i, a, o = !1;
	for (N && n.nodeType == 1 && r < va(n) && ya(n.childNodes[r], -1) && (o = !0);;) if (r > 0) {
		...
		for (; t && ya(t, -1);) i = n.parentNode, a = k(t), t = t.previousSibling;
		if (t) n = t, r = va(n);
		else {
...
function Sa(e) {
	...
	for (;;) if (r < i) {
		...
		let t = n.nextSibling;
		for (; t && ya(t, 1);) a = t.parentNode, o = k(t) + 1, t = t.nextSibling;
		if (t) n = t, r = 0, i = va(n);
		else {
			if (n = n.parentNode, n == e.dom) break;
			r = i = 0;
...
function wa(e, t) {
	for (; e && t == e.childNodes.length && !Pr(e);) t = k(e) + 1, e = e.parentNode;
...
function Ta(e, t) {
	for (; e && !t && !Pr(e);) t = k(e), e = e.parentNode;
	for (; e && t;) {
		let n = e.childNodes[t - 1];
		if (n.nodeType == 3) return n;
		if (n.nodeType == 1 && n.contentEditable == "false") break;
...
function Ea(e, t, n) {
	if (t.nodeType != 3) {
		let e, r;
		(r = wa(t, n)) ? (t = r, n = 0) : (e = Ta(t, n)) && (t = e, n = e.nodeValue.length);
	}
...
function Da(e, t) {
	...
	if (!(P || Jr) && n.parent.inlineContent) {
...
function Oa(e, t, n) {
	let r = e.state.selection;
	if (r instanceof T && !r.empty || n.indexOf("s") > -1 || I && n.indexOf("m") > -1) return !1;
	let { $from: i, $to: a } = r;
	if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
		let n = ha(e.state, t);
		if (n && n instanceof E) return ga(e, n);
	}
	if (!i.parent.inlineContent) {
		let n = t < 0 ? i : a, o = r instanceof _n ? w.near(n, t) : w.findFrom(n, t);
		return o ? ga(e, o) : !1;
	}
	return !1;
}
...
function ja(e) {
	...
	if (t && t.nodeType == 1 && n == 0 && t.firstChild && t.firstChild.contentEditable == "false") {
		let n = t.firstChild;
		Aa(e, n, "true"), setTimeout(() => Aa(e, n, "false"), 20);
	}
	return !1;
}
function Ma(e) {
...
function Na(e, t) {
	let n = t.keyCode, r = Ma(t);
	if (n == 8 || I && n == 72 && r == "c") return ka(e, -1) || ba(e, -1);
	if (n == 46 && !t.shiftKey || I && n == 68 && r == "c") return ka(e, 1) || ba(e, 1);
	if (n == 13 || n == 27) return !0;
	if (n == 37 || I && n == 66 && r == "c") {
		let t = n == 37 ? Da(e, e.state.selection.from) == "ltr" ? -1 : 1 : -1;
		return _a(e, t, r) || ba(e, t);
	}
	if (n == 39 || I && n == 70 && r == "c") {
		let t = n == 39 ? Da(e, e.state.selection.from) == "ltr" ? 1 : -1 : 1;
		return _a(e, t, r) || ba(e, t);
	}
	return n == 38 || I && n == 80 && r == "c" ? Oa(e, -1, r) || ba(e, -1) : n == 40 || I && n == 78 && r == "c" ? ja(e) || Oa(e, 1, r) || ba(e, 1) : !(r != (I ? "m" : "c") || n != 66 && n != 73 && n != 89 && n != 90);
}
function Pa(e, t) {
	...
	let o = e.someProp("clipboardSerializer") || $e.fromSchema(e.state.schema), s = Wa(), c = s.createElement("div");
	c.appendChild(o.serializeFragment(r, { document: s }));
	let l = c.firstChild, u, d = 0;
	for (; l && l.nodeType == 1 && (u = Ua[l.nodeName.toLowerCase()]);) {
...
function Fa(e, t, n, r, i) {
	...
	if (c || (c = (e.someProp("clipboardParser") || e.someProp("domParser") || ze.fromSchema(e.state.schema)).parseSlice(s, {
		...
		context: i,
		ruleFromNode(e) {
			return e.nodeName == "BR" && !e.nextSibling && e.parentNode && !Ia.test(e.parentNode.nodeName) ? { ignore: !0 } : null;
		}
	})), f) c = Ya(Ha(c, +f[1], +f[2]), f[4]);
	else if (c = d.maxOpen(La(c.content, i), !0), c.openStart || c.openEnd) {
		let e = 0, t = 0;
...
var Ia = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function La(e, t) {
	...
	for (let n = t.depth; n >= 0; n--) {
		...
		if (e.forEach((e) => {
			...
			if (!t) return o = null;
			if (n = o.length && i.length && za(t, i, e, o[o.length - 1], 0)) o[o.length - 1] = n;
			else {
...
function za(e, t, n, r, i) {
	if (i < e.length && i < t.length && e[i] == t[i]) {
		let o = za(e, t, n, r.lastChild, i + 1);
...
function Ba(e, t) {
	if (t == 0) return e;
	let n = e.content.replaceChild(e.childCount - 1, Ba(e.lastChild, t - 1)), r = e.contentMatchAt(e.childCount).fillBefore(a.empty, !0);
	return e.copy(n.append(r));
}
function Va(e, t, n, r, i, o) {
	let s = t < 0 ? e.firstChild : e.lastChild, c = s.content;
	return e.childCount > 1 && (o = 0), i < r - 1 && (c = Va(c, t, n, r, i + 1, o)), i >= n && (c = t < 0 ? s.contentMatchAt(0).fillBefore(c, o <= i).append(c) : c.append(s.contentMatchAt(s.childCount).fillBefore(a.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, s.copy(c));
}
function Ha(e, t, n) {
	return t < e.openStart && (e = new d(Va(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new d(Va(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e;
}
var Ua = {
	thead: ["table"],
	tbody: ["table"],
...
function Ka(e) {
	...
	if (!t) return e;
	if (!Ga) {
		if (Ga = t.defaultPolicy) try {
			return Ga.createHTML(e);
		} catch {}
		Ga = t.createPolicy("ProseMirrorClipboard", { createHTML: (e) => e });
	}
	return Ga.createHTML(e);
}
function qa(e) {
	...
	let n = Wa(), r = n.body, i = /<([a-z][^>\s]+)/i.exec(e), a;
	if ((a = i && Ua[i[1].toLowerCase()]) && (e = a.map((e) => "<" + e + ">").join("") + e + a.map((e) => "</" + e + ">").reverse().join("")), r.innerHTML = Ka(e), a) for (let e = 0; e < a.length; e++) r = r.querySelector(a[e]) || r;
...
function Qa(e) {
	for (let t in H) {
		...
		e.dom.addEventListener(t, e.input.eventHandlers[t] = (t) => {
			no(e, t) && !to(e, t) && (e.editable || !(t.type in U)) && n(e, t);
		}, Xa[t] ? { passive: !0 } : void 0);
	}
	F && e.dom.addEventListener("input", () => null), eo(e);
}
function W(e, t) {
...
function ro(e, t) {
	!to(e, t) && H[t.type] && (e.editable || !(t.type in U)) && H[t.type](e, t);
}
U.keydown = (e, t) => {
	let n = t;
	if (e.input.shiftKey = n.keyCode == 16 || n.shiftKey, !xo(e) && (e.input.lastKeyCode = n.keyCode, e.input.lastKeyCodeTime = Date.now(), !(L && P && n.keyCode == 13))) {
		if (n.keyCode != 229 && e.domObserver.forceFlush(), qr && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
			let t = Date.now();
		...
		} else e.someProp("handleKeyDown", (t) => t(e, n)) || Na(e, n) ? n.preventDefault() : W(e, "key");
	}
}, U.keyup = (e, t) => {
	t.keyCode == 16 && (e.input.shiftKey = !1);
}, U.keypress = (e, t) => {
	let n = t;
	if (xo(e) || !n.charCode || n.ctrlKey && !n.altKey || I && n.metaKey) return;
...
function co(e, t) {
	...
	return r && r.isAtom && E.isSelectable(r) ? (so(e, new E(n), "pointer"), !0) : !1;
}
function lo(e, t) {
	if (t == -1) return !1;
	...
	return i != null && (so(e, E.create(e.state.doc, i), "pointer"), !0);
}
...
function mo(e, t, n) {
	...
	let r = ho(e, t, !0), i = e.state.doc;
	return r ? (so(e, r, "pointer"), r instanceof T && i.eq(e.state.doc) && (e.input.mouseDown = new bo(e, r)), !0) : !1;
}
function ho(e, t, n) {
	let r = e.state.doc;
...
var _o = I ? "metaKey" : "ctrlKey";
H.mousedown = (e, t) => {
	let n = t;
	e.input.shiftKey = n.shiftKey;
	let r = go(e), i = Date.now(), a = "singleClick";
	i - e.input.lastClick.time < 500 && ao(n, e.input.lastClick) && !n[_o] && e.input.lastClick.button == n.button && (e.input.lastClick.type == "singleClick" ? a = "doubleClick" : e.input.lastClick.type == "doubleClick" && (a = "tripleClick")), e.input.lastClick = {
		time: i,
		x: n.clientX,
		y: n.clientY,
		type: a,
	...
	o && (a == "singleClick" ? e.input.mouseDown = new yo(e, o, n, !!r) : (a == "doubleClick" ? fo : po)(e, o.pos, o.inside, n) ? n.preventDefault() : W(e, "pointer"));
};
var vo = class {
	constructor(e) {
	...
	constructor(e, t, n, r) {
		super(e), this.pos = t, this.event = n, this.flushed = r, this.delayedSelectionSync = !1, this.startDoc = e.state.doc, this.selectNode = !!n[_o], this.allowDefault = n.shiftKey;
		let i, a;
		...
		n.button == 0 && (i.type.spec.draggable && i.type.spec.selectable !== !1 || c instanceof E && c.from <= a && c.to > a) && (this.mightDrag = {
			...
			setUneditable: !!(this.target && N && !this.target.hasAttribute("contentEditable"))
		}), this.target && this.mightDrag && (this.mightDrag.addAttr || this.mightDrag.setUneditable) && (this.view.domObserver.stop(), this.mightDrag.addAttr && (this.target.draggable = !0), this.mightDrag.setUneditable && setTimeout(() => {
			this.view.input.mouseDown == this && this.target.setAttribute("contentEditable", "false");
		}, 20), this.view.domObserver.start()), W(e, "pointer");
	}
	done() {
		super.done(), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => {
			this.view.isDestroyed || V(this.view);
		});
	}
	up(e) {
		if (this.done(), !this.view.dom.contains(e.target)) return;
		let t = this.pos;
		this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(io(e))), this.updateAllowDefault(e), this.allowDefault || !t ? W(this.view, "pointer") : uo(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || F && this.mightDrag && !this.mightDrag.node.isAtom || P && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (so(this.view, w.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : W(this.view, "pointer");
	}
	move(e) {
		this.updateAllowDefault(e), W(this.view, "pointer"), super.move(e);
	}
	...
	move(e) {
		...
		e.preventDefault(), W(this.view, "pointer");
		let t = this.view.posAtCoords(io(e)), n = t && ho(this.view, t.inside, !1);
		if (!n) return;
		let { doc: r } = this.view.state, i = this.startSelection, [a, o] = n.from < i.from ? [i.to, n.from] : [i.from, n.to];
		so(this.view, T.create(r, a, o), "pointer");
	}
};
H.touchstart = (e) => {
	e.input.lastTouch = Date.now(), go(e), W(e, "pointer");
}, H.touchmove = (e) => {
	e.input.lastTouch = Date.now(), W(e, "pointer");
}, H.contextmenu = (e) => go(e);
function xo(e, t) {
	return e.composing ? !0 : F && Math.abs(Date.now() - e.input.compositionEndedAt) < 500 ? (e.input.compositionEndedAt = -2e8, !0) : !1;
}
var So = L ? 5e3 : -1;
U.compositionstart = U.compositionupdate = (e) => {
	if (!e.composing) {
		...
		if (t.selection instanceof T && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some((e) => e.type.spec.inclusive === !1) || P && Jr && Co(e))) e.markCursor = e.state.storedMarks || n.marks(), Do(e, !0), e.markCursor = null;
		else if (Do(e, !t.selection.empty), N && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
			let t = e.domSelectionRange();
...
function wo(e, t) {
	clearTimeout(e.input.composingTimeout), t > -1 && (e.input.composingTimeout = setTimeout(() => Do(e), t));
}
function To(e) {
...
function Do(e, t = !1) {
	if (!(L && e.domObserver.flushingSoon >= 0)) {
...
var ko = M && Wr < 15 || qr && Xr < 604;
H.copy = U.cut = (e, t) => {
	let n = t, r = e.state.selection, i = n.type == "cut";
	if (r.empty) return;
	let a = ko ? null : n.clipboardData, { dom: o, text: s } = Pa(e, r.content());
	a ? (n.preventDefault(), a.clearData(), a.setData("text/html", o.innerHTML), a.setData("text/plain", s)) : Oo(e, o), i && e.dispatch(e.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function Ao(e) {
...
function jo(e, t) {
	...
	setTimeout(() => {
		e.focus(), r.parentNode && r.parentNode.removeChild(r), n ? Mo(e, r.value, null, i, t) : Mo(e, r.textContent, r.innerHTML, i, t);
	}, 50);
}
function Mo(e, t, n, r, i) {
	let a = Fa(e, t, n, r, e.state.selection.$from);
	if (e.someProp("handlePaste", (t) => t(e, i, a || d.empty))) return !0;
	if (!a) return !1;
	let o = Ao(a), s = o ? e.state.tr.replaceSelectionWith(o, r) : e.state.tr.replaceSelection(a);
...
U.paste = (e, t) => {
	let n = t;
	if (e.composing && !L) return;
	let r = ko ? null : n.clipboardData, i = e.input.shiftKey && e.input.lastKeyCode != 45;
	r && Mo(e, No(r), r.getData("text/html"), i, n) ? n.preventDefault() : jo(e, n);
};
var Po = class {
	constructor(e, t, n) {
...
H.dragstart = (e, t) => {
	...
	let { dom: s, text: c, slice: l } = Pa(e, (o || e.state.selection).content());
	(!n.dataTransfer.files.length || !P || Kr > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(ko ? "Text" : "text/html", s.innerHTML), n.dataTransfer.effectAllowed = "copyMove", ko || n.dataTransfer.setData("text/plain", c), e.dragging = new Po(l, Io(e, n), o);
}, H.dragend = (e) => {
	let t = e.dragging;
	window.setTimeout(() => {
		e.dragging == t && (e.dragging = null);
	}, 50);
}, U.dragover = U.dragenter = (e, t) => t.preventDefault(), U.drop = (e, t) => {
	try {
		Lo(e, t, e.dragging);
	} finally {
		e.dragging = null;
...
function Lo(e, t, n) {
	...
	a ? e.someProp("transformPasted", (t) => {
		a = t(a, e, !1);
	}) : a = Fa(e, No(t.dataTransfer), ko ? null : t.dataTransfer.getData("text/html"), !1, i);
	let o = !!(n && Io(e, t));
	...
	if (!a) return;
	t.preventDefault();
	let s = a ? Wt(e.state.doc, i.pos, a) : i.pos;
	s ?? (s = i.pos);
	let c = e.state.tr;
	if (o) {
		let { node: e } = n;
...
H.focus = (e) => {
	e.input.lastFocus = Date.now(), e.focused || (e.domObserver.stop(), e.dom.classList.add("ProseMirror-focused"), e.domObserver.start(), e.focused = !0, setTimeout(() => {
		e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && V(e);
	}, 20));
}, H.blur = (e, t) => {
	let n = t;
	...
	if (L && t.inputType == "deleteContentBackward") {
...
var zo = class e {
	...
	map(e, t, n, r) {
		...
		return a ? null : new Ho(i - n, i - n, this);
	}
	valid() {
		return !0;
	}
	eq(t) {
		return this == t || t instanceof e && (this.spec.key && this.spec.key == t.spec.key || this.toDOM == t.toDOM && Ro(this.spec, t.spec));
	}
	destroy(e) {
	...
	map(e, t, n, r) {
		...
		return i >= a ? null : new Ho(i, a, this);
	}
	valid(e, t) {
		return t.from < t.to;
	}
	eq(t) {
		return this == t || t instanceof e && Ro(this.attrs, t.attrs) && Ro(this.spec, t.spec);
	}
	static is(t) {
	...
	map(e, t, n, r) {
		...
		return a.deleted || a.pos <= i.pos ? null : new Ho(i.pos - n, a.pos - n, this);
	}
	valid(e, t) {
	...
	map(e, t, n) {
		return this == K || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || Wo);
	}
	mapInner(t, n, r, i, a) {
		let o;
		...
		return this.children.length ? Ko(this.children, o || [], t, n, r, i, a) : o ? new e(o.sort(Qo), Uo) : K;
	}
	add(t, n) {
	...
	addInner(t, n, r) {
		...
		t.forEach((e, t) => {
			...
			if (s = Yo(n, e, o)) {
				...
				i[a] == t ? i[a + 2] = i[a + 2].addInner(e, s, o + 1) : i.splice(a, 0, t, t + e.nodeSize, Zo(s, e, o + 1, Wo)), a += 3;
			}
		});
		let o = qo(a ? Xo(n) : n, -r);
...
G.empty = new G([], []), G.removeOverlap = $o;
var K = G.empty, Go = class e {
	constructor(e) {
		this.members = e;
	}
	map(t, n) {
...
function qo(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		let i = e[r];
		n.push(new Ho(i.from + t, i.to + t, i.type));
	}
	return n;
}
...
function ts(e) {
	...
	return e.someProp("decorations", (n) => {
		let r = n(e.state);
		r && r != K && t.push(r);
	}), e.cursorWrapper && t.push(G.create(e.state.doc, [e.cursorWrapper.deco])), Go.from(t);
}
var ns = {
	childList: !0,
	characterData: !0,
	...
	constructor(e, t) {
		this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new is(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((t) => {
			...
			M && Wr <= 11 && t.some((e) => e.type == "childList" && e.removedNodes.length || e.type == "characterData" && e.oldValue.length > e.target.nodeValue.length) ? this.flushSoon() : F && e.composing && t.some((e) => e.type == "childList" && e.target.nodeName == "TR") ? (e.input.badSafariComposition = !0, this.flushSoon()) : this.flush();
	...
	onSelectionChange() {
		if (fa(this.view)) {
			if (this.suppressingSelectionUpdates) return V(this.view);
			if (M && Wr <= 11 && !this.view.state.selection.empty) {
	...
	flush() {
		...
		if (s.some((e) => e.nodeName == "BR") && (e.input.lastKeyCode == 8 || e.input.lastKeyCode == 46 || P && (e.composing || e.input.compositionEndedAt > Date.now() - 50) && t.some((e) => e.type == "childList" && e.removedNodes.length))) {
		...
		let c = null;
		i < 0 && r && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Fr(n) && (c = ta(e)) && c.eq(w.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, V(e), this.currentSelection.set(n), e.scrollToSelection()) : (i > -1 || r) && (i > -1 && (e.docView.markDirty(i, a), ls(e)), e.input.badSafariComposition && (e.input.badSafariComposition = !1, ps(e, s)), this.handleDOMChange(i, a, o, s), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || V(e), this.currentSelection.set(n));
	}
	registerMutation(e, t) {
		...
		if (e.type == "childList") {
			...
			if (M && Wr <= 11 && e.addedNodes.length) for (let t = 0; t < e.addedNodes.length; t++) {
...
function ls(e) {
	if (!ss.has(e) && (ss.set(e, null), [
		...
		if (e.requiresGeckoHackNode = N, cs) return;
...
var hs = (e) => (t) => {
	...
	if (t.nodeName == "BR" && t.parentNode) {
		if (F && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
			let e = document.createElement("div");
			return e.appendChild(document.createElement("li")), { skip: e };
		}
		if (t.parentNode.lastChild == t || F && /^(tr|table)$/i.test(t.parentNode.nodeName)) return { ignore: !0 };
	} else if (t.nodeName == "IMG" && t.getAttribute("mark-placeholder")) return { ignore: !0 };
	return null;
}, gs = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|img|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function _s(e, t, n, r, i) {
	...
	if (e.input.compositionPendingChanges = 0, t < 0) {
		...
		if (n && !e.state.selection.eq(n)) {
			if (P && L && e.input.lastKeyCode === 13 && Date.now() - 100 < e.input.lastKeyCodeTime && e.someProp("handleKeyDown", (t) => t(e, Ir(13, "Enter")))) return;
	...
	let c = e.state.selection, l = ms(e, t, n, i), u = e.state.doc, d = u.slice(l.from, l.to), f, p;
	...
	if (m && e.input.domChangeCount++, (qr && e.input.lastIOSEnter > Date.now() - 225 || L) && i.some((e) => e.nodeType == 1 && !gs.test(e.nodeName)) && (!m || m.endA >= m.endB) && e.someProp("handleKeyDown", (t) => t(e, Ir(13, "Enter")))) {
	...
	e.state.selection.from < e.state.selection.to && m.start == m.endB && e.state.selection instanceof T && (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= l.from ? m.start = e.state.selection.from : m.endA < e.state.selection.to && m.endA >= e.state.selection.to - 2 && e.state.selection.to <= l.to && (m.endB += e.state.selection.to - m.endA, m.endA = e.state.selection.to)), M && Wr <= 11 && m.endB == m.start + 1 && m.endA == m.start && m.start > l.from && l.doc.textBetween(m.start - l.from - 1, m.start - l.from + 1) == " \xA0" && (m.start--, m.endA--, m.endB--);
	...
	if ((qr && e.input.lastIOSEnter > Date.now() - 225 && (!_ || i.some((e) => e.nodeName == "DIV" || e.nodeName == "P")) || !_ && h.pos < l.doc.content.size && (!h.sameParent(g) || !h.parent.inlineContent) && h.pos < g.pos && !/\S/.test(l.doc.textBetween(h.pos, g.pos, "", ""))) && e.someProp("handleKeyDown", (t) => t(e, Ir(13, "Enter")))) {
		e.input.lastIOSEnter = 0;
		return;
	}
	if (e.state.selection.anchor > m.start && bs(u, m.start, m.endA, h, g) && e.someProp("handleKeyDown", (t) => t(e, Ir(8, "Backspace")))) {
		L && P && e.domObserver.suppressSelectionUpdates();
		return;
	}
	P && m.endB == m.start && (e.input.lastChromeDelete = Date.now()), L && !_ && h.start() != g.start() && g.parentOffset == 0 && h.depth == g.depth && l.sel && l.sel.anchor == l.sel.head && l.sel.head == m.endA && (m.endB -= 2, g = l.doc.resolveNoCache(m.endB - l.from), setTimeout(() => {
	...
	let v = m.start, y = m.endA, te = (t) => {
		...
		if (l.sel) {
			...
			t && !(P && e.composing && t.empty && (m.start != m.endB || e.input.lastChromeDelete < Date.now() - 100) && (t.head == v || t.head == n.mapping.map(y) - 1) || M && t.empty && t.head == v) && n.setSelection(t);
		}
		return a && n.setMeta("composition", a), n.scrollIntoView();
	}, ne;
	if (_) {
		if (h.pos == g.pos) {
			M && Wr <= 11 && h.parentOffset == 0 && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => V(e), 20));
			let t = te(e.state.tr.delete(v, y)), n = u.resolve(m.start).marksAcross(u.resolve(m.endA));
			n && t.ensureMarks(n), e.dispatch(t);
		} else if (m.endA == m.endB && (ne = ys(h.parent.content.cut(h.parentOffset, g.parentOffset), ee.parent.content.cut(ee.parentOffset, m.endA - ee.start())))) {
			let t = te(e.state.tr);
...
var Cs = class {
	constructor(e, t) {
		this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Za(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(As), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = Es(this), Ts(this), this.nodeViews = Os(this), this.docView = Fi(this.state.doc, ws(this), ts(this), this.dom, this), this.domObserver = new as(this, (e, t, n, r) => _s(this, e, t, n, r)), this.domObserver.start(), Qa(this), this.updatePluginViews();
	}
	get composing() {
	...
	updateStateInner(e, t) {
		...
		if (a || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
			let e = Os(this);
			ks(e, this.nodeViews) && (this.nodeViews = e, r = !0);
		}
		(a || t.handleDOMEvents != this._props.handleDOMEvents) && eo(this), this.editable = Es(this), Ts(this);
		let o = ts(this), s = ws(this), c = n.plugins != e.plugins && !n.doc.eq(e.doc) ? "reset" : e.scrollToSelection > n.scrollToSelection ? "to selection" : "preserve", l = r || !this.docView.matchesNode(e.doc, s, o);
		(l || !e.selection.eq(n.selection)) && (i = !0);
		let u = c == "preserve" && i && this.dom.style.overflowAnchor == null && ei(this);
		if (i) {
			this.domObserver.stop();
			let t = l && (M || P) && !this.composing && !n.selection.empty && !e.selection.empty && Ds(n.selection, e.selection);
			if (l) {
			...
			t || !(i && this.domObserver.currentSelection.eq(this.domSelectionRange()) && ma(this) && i.delaySelUpdate()) ? V(this, t) : (la(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
		}
	...
	updateDraggedNode(e, t) {
		...
		this.dragging = new Po(e.slice, e.move, r < 0 ? void 0 : E.create(this.state.doc, r));
	}
	someProp(e, t) {
	...
	focus() {
		this.domObserver.stop(), this.editable && ai(this.dom), V(this), this.domObserver.start();
	}
	get root() {
		let e = this._root;
		if (e == null) {
	...
	pasteHTML(e, t) {
		return Mo(this, "", e, !1, t || new ClipboardEvent("paste"));
	}
	pasteText(e, t) {
		return Mo(this, e, null, !0, t || new ClipboardEvent("paste"));
	}
	...
	domSelectionRange() {
		...
		return e ? F && this.root.nodeType === 11 && Lr(this.dom.ownerDocument) == this.dom && ds(this, e) || e : {
			focusNode: null,
			focusOffset: 0,
			anchorNode: null,
			anchorOffset: 0
...
Cs.prototype.dispatch = function(e) {
...
function ws(e) {
	...
	}), t.translate || (t.translate = "no"), [Ho.node(0, e.state.doc.content.size, t)];
}
function Ts(e) {
	if (e.markCursor) {
...
var q = class e extends w {
	...
	static valid(e) {
		let t = e.parent;
		if (t.inlineContent || !Ns(e) || !Ps(e)) return !1;
...
q.prototype.visible = !1, q.findFrom = q.findGapCursorFrom, w.jsonID("gapcursor", q);
var js = class e {
	constructor(e) {
		this.pos = e;
	}
	...
	resolve(e) {
		...
		return q.valid(t) ? new q(t) : w.near(t);
	}
};
function Ms(e) {
...
function Ns(e) {
	for (let t = e.depth; t >= 0; t--) {
		...
		for (let e = r.child(n - 1);; e = e.lastChild) {
			if (e.childCount == 0 && !e.inlineContent || Ms(e.type)) return !0;
...
function Rs(e, t, n) {
	...
	return i && i.inside > -1 && E.isSelectable(e.state.doc.nodeAt(i.inside)) ? !1 : (e.dispatch(e.state.tr.setSelection(new q(r))), !0);
}
function zs(e, t) {
...
function Bs(e) {
	...
	return t.className = "ProseMirror-gapcursor", G.create(e.doc, [Ho.widget(e.selection.head, t, { key: "gapcursor" })]);
}
//#endregion
//#region node_modules/rope-sequence/dist/index.js
var Vs = 200, J = function() {};
J.prototype.append = function(e) {
	return e.length ? (e = J.from(e), !this.length && e || e.length < Vs && this.leafAppend(e) || this.length < Vs && e.leafPrepend(this) || this.appendInner(e)) : this;
	...
	return e instanceof J ? e : e && e.length ? new Hs(e) : J.empty;
};
var Hs = /* @__PURE__ */ function(e) {
	...
	return t.prototype.flatten = function() {
		...
		if (this.length + e.length <= Vs) return new t(this.values.concat(e.flatten()));
	}, t.prototype.leafPrepend = function(e) {
		if (this.length + e.length <= Vs) return new t(e.flatten().concat(this.values));
...
var Us = /* @__PURE__ */ function(e) {
	...
	popEvent(t, n) {
		...
		return this.items.forEach((t, n) => {
			...
			if (i) {
				...
				e && o.maybeStep(e).doc && (n = o.mapping.maps[o.mapping.maps.length - 1], l.push(new qs(n, void 0, void 0, l.length + u.length))), a--, n && i.appendMap(n, a);
	...
	addTransform(t, n, r, i) {
		...
		for (let e = 0; e < t.steps.length; e++) {
			let r = t.steps[e].invert(t.docs[e]), l = new qs(t.mapping.maps[e], r, n), u;
			(u = c && c.merge(l)) && (l = u, e ? a.pop() : s = s.slice(0, s.length - 1)), a.push(l), n && (o++, n = void 0), i || (c = l);
		}
		let l = o - r.depth;
		return l > Ys && (s = Ks(s, l), o -= l), new e(s.append(a), o);
	}
	remapping(e, t) {
		let n = new _t();
	...
	addMaps(t) {
		return this.eventCount == 0 ? this : new e(this.items.append(t.map((e) => new qs(e))), this.eventCount);
	}
	rebased(t, n) {
		...
		this.items.forEach((e) => {
			...
			if (e.step) {
				...
				l && s++, r.push(new qs(i, o, l));
			} else r.push(new qs(i));
		}, i);
		let l = [];
		for (let e = n; e < o; e++) l.push(new qs(a.maps[e]));
		let u = this.items.slice(0, i).append(l).append(r), d = new e(u, s);
		return d.emptyItemCount() > Ws && (d = d.compress(this.items.length - r.length)), d;
	}
	emptyItemCount() {
		let e = 0;
		...
		return this.items.forEach((e, o) => {
			if (o >= t) i.push(e), e.selection && a++;
				...
				if (r--, o && n.appendMap(o, r), t) {
					...
					s && a++;
					let c = new qs(o.invert(), t, s), l, u = i.length - 1;
...
function Xs(e, t, n, r) {
	let i = n.getMeta(ic), a;
	if (i) return i.historyState;
	n.getMeta(ac) && (e = new Js(e.done, e.undone, null, 0, -1));
	let o = n.getMeta("appendedTransaction");
	if (n.steps.length == 0) return e;
	if (o && o.getMeta(ic)) return o.getMeta(ic).redo ? new Js(e.done.addTransform(n, void 0, r, rc(t)), e.undone, Qs(n.mapping.maps), e.prevTime, e.prevComposition) : new Js(e.done, e.undone.addTransform(n, void 0, r, rc(t)), null, e.prevTime, e.prevComposition);
	if (n.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
		let i = n.getMeta("composition"), a = e.prevTime == 0 || !o && e.prevComposition != i && (e.prevTime < (n.time || 0) - r.newGroupDelay || !Zs(n, e.prevRanges)), s = o ? $s(e.prevRanges, n.mapping) : Qs(n.mapping.maps);
		return new Js(e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, rc(t)), Gs.empty, s, n.time, i ?? e.prevComposition);
	}
	return (a = n.getMeta("rebased")) ? new Js(e.done.rebased(n, a), e.undone.rebased(n, a), $s(e.prevRanges, n.mapping), e.prevTime, e.prevComposition) : new Js(e.done.addMaps(n.mapping.maps), e.undone.addMaps(n.mapping.maps), $s(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
}
function Zs(e, t) {
	if (!t) return !1;
...
function ec(e, t, n) {
	let r = rc(t), i = ic.get(t).spec.config, a = (n ? e.undone : e.done).popEvent(t, r);
	if (!a) return null;
	let o = a.selection.resolve(a.transform.doc), s = (n ? e.done : e.undone).addTransform(a.transform, t.selection.getBookmark(), i, r), c = new Js(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
	return a.transform.setSelection(o).setMeta(ic, {
		redo: n,
		historyState: c
	});
}
...
var ic = new Pn("history"), ac = new Pn("closeHistory");
function oc(e = {}) {
	return e = {
		depth: e.depth || 100,
		...
		state: {
			init() {
				return new Js(Gs.empty, Gs.empty, null, 0, -1);
			},
			apply(t, n, r) {
				return Xs(n, r, t, e);
			}
		...
		props: { handleDOMEvents: { beforeinput(e, t) {
			let n = t.inputType, r = n == "historyUndo" ? cc : n == "historyRedo" ? lc : null;
...
function Cc(e) {
	return e === "basefont" || e === "param" || e === "br" || e === "wbr" ? new Set(vc[e]) : /* @__PURE__ */ new Set([..._c, ...vc[e] || []]);
}
function wc(e) {
	let t = Sc(e.getAttribute("style")).map(([e, t]) => !yc.has(e) || !t || /(?:expression\s*\(|javascript\s*:|behavior\s*:)/i.test(t) ? "" : `${e}:${t}`).filter(Boolean).join(";");
...
function Tc(e) {
	...
	for (let i of Array.from(e.attributes)) {
		...
		if ((xc.has(a) || s) && bc.test(o.replace(/\s+/g, ""))) {
			e.removeAttribute(i.name);
			continue;
		}
...
function Y(e, t = {}) {
	let n = { ...e || {} }, r = Array.isArray(n[gc]) ? n[gc] : [];
	delete n[gc];
	let i = { ...n };
...
function Dc(e, t) {
	let n = { ...e || {} }, r = n[gc];
	delete n[gc];
	let i = new Map(Sc(n.style));
	for (let [e, n] of Object.entries(t)) n == null || n === "" ? i.delete(e) : i.set(e, String(n));
	return i.size ? n.style = `${Array.from(i, ([e, t]) => `${e}:${t}`).join(";")};` : delete n.style, r && (n[gc] = r), Y(n);
}
//#endregion
...
function kc(e) {
	return {
		...
		toDOM: (t) => [
			"span",
			Dc(t.attrs.extra, { [e]: t.attrs.value }),
			0
		]
	};
}
var Ac = {
	...
	strong: Oc(["strong", "b"], "strong"),
	em: Oc(["em", "i"], "em"),
	underline: Oc(["u"], "u"),
	strike: Oc(["s", "strike"], "s"),
	code: Oc(["code"], "code"),
	sub: Oc(["sub"], "sub"),
	sup: Oc(["sup"], "sup"),
	fontSize: kc("font-size"),
	fontColor: kc("color"),
	bgColor: kc("background-color"),
	fontFamily: kc("font-family"),
	rawMark: {
		attrs: {
			tag: { default: "span" },
			extra: { default: null }
...
if (typeof WeakMap < "u") {
	...
	jc = (t) => e.get(t), Mc = (t, n) => (e.set(t, n), n);
} else {
	let e = [], t = 0;
	jc = (t) => {
		for (let n = 0; n < e.length; n += 2) if (e[n] == t) return e[n + 1];
	}, Mc = (n, r) => (t == 10 && (t = 0), e[t++] = n, e[t++] = r);
}
var X = class {
	constructor(e, t, n, r) {
...
function Fc(e, t, n) {
	...
	for (let i = 0; i < e.map.length; i++) {
		...
		for (let n = 0; n < c.colspan; n++) {
			...
			r != null && (!c.colwidth || c.colwidth[n] != r) && ((s || (s = Ic(c)))[n] = r);
		}
...
var Z = class e extends w {
	constructor(e, t = e) {
		...
		let c = s.map((e) => {
			...
			let r = i + e + 1;
			return new fn(o.resolve(r), o.resolve(r + t.content.size));
		});
	...
	content() {
		...
		for (let n = r.top; n < r.bottom; n++) {
			...
			for (let a = n * t.width + r.left, o = r.left; o < r.right; o++, a++) {
				...
				if (l > 0 || u > 0) {
					let e = c.attrs;
					if (l > 0 && (e = Yc(e, 0, l)), u > 0 && (e = Yc(e, e.colspan - u, u)), o.left < r.left) {
	...
	getBookmark() {
		return new Xc(this.$anchorCell.pos, this.$headCell.pos);
	}
};
Z.prototype.visible = !1, w.jsonID("cell", Z);
var Xc = class e {
	constructor(e, t) {
		this.anchor = e, this.head = t;
	}
	...
	resolve(e) {
		...
		return t.parent.type.spec.tableRole == "row" && n.parent.type.spec.tableRole == "row" && t.index() < t.parent.childCount && n.index() < n.parent.childCount && qc(t, n) ? new Z(t, n) : w.near(n, 1);
	}
};
new Pn("fix-tables");
function Zc(e) {
	let t = e.selection, n = Wc(e), r = n.node(-1), i = n.start(-1), a = X.get(r);
	return {
...
function Qc(e) {
	return function(t, n) {
		if (!Uc(t)) return !1;
		if (n) {
			let r = Vc(t.schema), i = Zc(t), a = t.tr, o = i.map.cellsInRect(e == "column" ? {
				left: i.left,
				top: 0,
				right: i.right,
				bottom: i.map.height
...
function el(e, t) {
	return t = t || { useDeprecatedLogic: !1 }, t.useDeprecatedLogic ? Qc(e) : function(t, n) {
		if (!Uc(t)) return !1;
		if (n) {
			let r = Vc(t.schema), i = Zc(t), a = t.tr, o = $c("row", i, r), s = $c("column", i, r), c = (e === "column" ? o : e === "row" && s) ? 1 : 0, l = e == "column" ? {
				left: 0,
				top: c,
				right: 1,
				bottom: i.map.height
...
el("row", { useDeprecatedLogic: !0 }), el("column", { useDeprecatedLogic: !0 }), el("cell", { useDeprecatedLogic: !0 });
function tl(e, t) {
	let n = e.selection;
	if (!(n instanceof Z)) return !1;
	if (t) {
		let r = e.tr, i = Vc(e.schema).cell.createAndFill().content;
		n.forEachCell((e, t) => {
...
function rl(e, t) {
	return (n, r, i) => {
		if (!i) return !1;
		let a = n.selection;
		if (a instanceof Z) return nl(n, r, w.near(a.$headCell, t));
		if (e != "horiz" && !a.empty) return !1;
		let o = al(i, e, t);
		if (o == null) return !1;
		if (e == "horiz") return nl(n, r, w.near(n.doc.resolve(a.head + t), t));
		{
			let i = n.doc.resolve(o), a = Jc(i, e, t), s;
...
function il(e, t) {
	return (n, r, i) => {
		...
		let s = Jc(o.$headCell, e, t);
		return s ? nl(n, r, new Z(o.$anchorCell, s)) : !1;
	};
}
function al(e, t, n) {
...
function ml(e) {
	return { html: fl(e.getAttribute(Q)) };
}
//#endregion
...
var vl = Bc({
	...
	heading: {
		...
		toDOM: (e) => [
			`h${e.attrs.level}`,
			Dc(e.attrs.extra, { "text-align": e.attrs.align }),
			0
		]
	},
	blockquote: {
	...
	codeBlock: {
		...
		parseDOM: [{
			...
			getAttrs: (e) => ({
				extra: $(e),
				codeExtra: e.firstElementChild?.tagName === "CODE" ? $(e.firstElementChild) : null
			})
		}],
		toDOM: (e) => [
			"pre",
	...
	embed: {
		...
		toDOM: (e) => pl("div", "embed", e.attrs.html)
	},
	rhymixComponentBlock: {
		group: "block",
		atom: !0,
		...
		toDOM: (e) => pl("div", "component-block", e.attrs.html)
	},
	rhymixComponentInline: {
		inline: !0,
		group: "inline",
		...
		toDOM: (e) => pl("span", "component-inline", e.attrs.html)
	},
	rawBlock: {
		group: "block",
		atom: !0,
		...
		toDOM: (e) => pl("div", "block", e.attrs.html)
	},
	rawInline: {
		inline: !0,
		group: "inline",
		...
		toDOM: (e) => pl("span", "inline", e.attrs.html)
	},
	table: {
		...vl.table,
		content: "tableRow+",
	...
	tableCell: vl.table_cell,
	tableHeader: vl.table_header,
	text: { group: "inline" }
...
function wl(e) {
	for (let t of Array.from(e.querySelectorAll("*")).reverse()) {
		...
		xl.has(e) ? t.remove() : fc.has(e) ? Tc(t) : Cl(t);
	}
}
function Tl(e) {
...
function kl(e) {
	...
	return t === "a" ? e.hasAttribute("href") : t === "li" ? ["OL", "UL"].includes(e.parentElement?.tagName) : t === "tbody" ? e.parentElement?.tagName === "TABLE" : t === "tr" ? e.parentElement?.tagName === "TBODY" : t === "td" || t === "th" ? e.parentElement?.tagName === "TR" : t === "table" ? Tl(e) : t === "ol" || t === "ul" ? El(e) : t === "pre" ? Dl(e) : t !== "video" || Ol(e);
}
function Al(e) {
	let t = e.tagName.toLowerCase();
	if (xl.has(t)) {
	...
	if (!fc.has(t)) {
		for (let t of Array.from(e.children)) Al(t);
		Cl(e);
		return;
	}
	Tc(e);
	let n = e.getAttribute("editor_component"), r = t === "div" && e.hasAttribute("data-oembed-url"), i = bl.has(t) && kl(e);
	if (n || r || !i) {
		wl(e), Sl(e, n ? mc.has(t) ? "component-block" : "component-inline" : r ? "embed" : mc.has(t) ? "block" : "inline");
		return;
	}
	for (let t of Array.from(e.children)) Al(t);
}
...
function Pl(e) {
	...
	for (let e of Array.from(t.content.children)) Al(e);
	for (let e of Array.from(t.content.querySelectorAll("p"))) Ml(e);
	for (let e of Array.from(t.content.querySelectorAll("li,td,th,blockquote"))) Nl(e, !0);
	return Nl(t.content, !1), t.content.childNodes.length || (t.innerHTML = "<p></p>"), t.innerHTML;
}
//#endregion
...
function Fl(e) {
	...
	for (; t;) {
		...
		for (let n of Array.from(e.querySelectorAll("span[style]"))) {
			...
			r.setAttribute("style", n.getAttribute("style"));
			for (let t of Array.from(e.style)) r.style.setProperty(t, e.style.getPropertyValue(t), e.style.getPropertyPriority(t));
			e.setAttribute("style", r.style.cssText), n.replaceWith(e), t = !0;
		}
	}
}
function Il(e) {
...
function Ll(e) {
	for (let t of Array.from(e.querySelectorAll(`[${Q}]`))) {
...
function Bl(e, t) {
	...
	return n.appendChild($e.fromSchema(t).serializeFragment(e.content)), Il(n), Fl(n), Ll(n), zl(Rl(n.innerHTML));
}
//#endregion
...
function Hl(e) {
	let t = document.createElement("template");
	return t.innerHTML = Pl(e), ze.fromSchema(Vl).parse(t.content, { preserveWhitespace: "full" });
}
function Ul(e) {
	let t = document.createElement("template");
	return t.innerHTML = Pl(e), ze.fromSchema(Vl).parseSlice(t.content, { preserveWhitespace: "full" });
}
//#endregion
//#region src/main.js
...
function Zl(e) {
	return Bl({ content: e.view.state.selection.content().content }, Vl);
}
function Ql(e) {
	...
	return Object.values(Wl).find((e) => {
...
function ru(e) {
	...
	let a = {
		...
		config: t,
		sequence: n,
		primaryInput: ql(r, t.primaryKeyName) || { value: "" },
		contentInput: i,
		view: null,
		editable: null,
		compat: null,
		sync() {
			return this.view && (this.contentInput.value = Bl(this.view.state.doc, Vl)), this.contentInput.value;
		},
		updateDocument(e) {
			let t = kn.create({
				doc: Hl(e),
	...
	a.view = new Cs(e.querySelector(".rxeditor__surface"), {
		...
		transformPastedHTML: Pl,
		nodeViews: dc(),
		dispatchTransaction(e) {
			a.view.updateState(a.view.state.apply(e)), a.sync();
		}
	}), a.editable = a.view.dom, a.editable.editor_sequence = n, a.editable.setFocus = () => a.view.focus(), a.editable.replaceHTML = (e) => Xl(a, e), a.compat = $l(a), Wl[n] = a, r.setAttribute("editor_sequence", String(n)), Jl(r, "use_editor", "Y"), Jl(r, "use_html", "Y"), tu(a), eu(), window.editorRelKeys = window.editorRelKeys || [], window.editorRelKeys[n] = {
...
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", iu, { once: !0 }) : iu(), window.addEventListener("pageshow", iu);
//#endregion
